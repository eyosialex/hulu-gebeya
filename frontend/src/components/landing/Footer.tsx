        ...
        <div className="grid md:grid-cols-4 gap-10 mb-12">
          <div className="md:col-span-2">
            ...
            <p className="text-muted-foreground max-w-sm">
              Explore. Play. Earn. — Turn your everyday city into a board of
              missions and rewards.
            </p>
            <div className="mt-5 inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-3 py-2 text-xs text-muted-foreground">
          ...
          <div>
            <h4 className="font-display font-bold mb-4 text-sm uppercase tracking-widest text-muted-foreground">
              Company
            </h4>
